...
//------------
    ...
    function createInputConsole() {
        ...
        div=inputConsole;
            ...
            but.addEventListener("click", (e) => { toggleInputConsoleActive(); });
            h.appendChild(but);
        ...
        span.innerHTML=""+
        //"<font>"+time+"</font>"+
        "<font>["+msg.data[0]+", "+msg.data[1]+", "+msg.data[2]+"]</font>"+        
        "<font>&nbsp;"+name+"</font>"
        ;
        ...
        if(div.childNodes.length>maxItems) div.removeChild(div.childNodes[div.childNodes.length-1]);
